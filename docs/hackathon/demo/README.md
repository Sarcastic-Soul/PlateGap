...
| File | What it shows |
| --- | --- |
| `01-the-gap.png` | Indian hostel mess, Monday. 4 of 12 targets the menu cannot reach, ₹7.82 a day to close them, and the shadow prices underneath: zinc at ₹7.53/mg, one more roti worth ₹0.597, 100 g more appetite worth ₹3.47. |
...
| `03-the-menu-audit.png` | The institutional view. 600 students leak ₹271,698 a month; the top menu change recovers ₹85,193 of it. Each row says which duals it answers, and what one serving spends against the ceilings. |
